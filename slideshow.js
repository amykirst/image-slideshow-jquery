(function loadSlideShow() {
  ...
  // Hide all photos while page loads
  ...
  function showFirstPhoto() {
      $(".image:first-child").removeClass("hide");
    } // end showFirstPhoto
  ...
  function positionButtons() {
      $(".slideshow").each(function() {
        ...
        $(this).find(".previous").css("paddingBottom",
          percent);
  ...
  function addControls() {
      // Create buttons
      $(".slideshow").append(
        '<span class="next"><p tabindex="0">>></p></span>');
      $(".slideshow").append(
        '<span class="previous"><p tabindex="0"><<</p></span>');
  ...
  if ($("div").hasClass("slideshow")) {
    hideOnPageLoad();
    // Show images after page has loaded
